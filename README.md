...
GameHavocHytalePlugin is a single Hytale server plugin that hosts multiple "modules".
The first module fixes a hydration consistency issue with tilled soil on dedicated servers.
...
```
GameHavocHytalePlugin/src/main/java/com/gamehavochytaleplugin/HydrationTalePlugin.java
```
